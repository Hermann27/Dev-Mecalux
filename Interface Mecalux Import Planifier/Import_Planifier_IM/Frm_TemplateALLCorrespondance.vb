...
Public Class Frm_TemplateALLCorrespondance
    ...
    Private Sub AfficheSchemasConso()
        Try
            OleAdaptaterschema = New OleDbDataAdapter("select * from TEMPLATE WHERE CodeTbls='" & Critère & "' ORDER BY ORDRE", OleConnenection)
    ...
    Private Sub MiseàjourLeSchema()
        ...
        Dim Insertion2 As String = ""
        Dim ValeurDefault As String = ""
        Dim ChampSage As String = ""
        Try
            If DataListeIntegrer.RowCount >= 0 Then
                If MessageBox.Show("Souhaitez-vous changer de Société pour ce template parametrer", "Information mise à jour du template ", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                        ...
                        If Trim(DataListeIntegrer.Rows(n).Cells("Modifier").Value) = "True" Then
                            If DataListeIntegrer.Rows(n).Cells("InfosLibre").Value = "True" Then
                                ...
                                If IsDBNull(ValeurDefault) = False Or IsDBNull(ChampSage) = False Then
                                    Insertion = "UPDATE TEMPLATE SET DefaultValue='" & Join(Split(ValeurDefault, "'"), "''") & "',ChampSage='" & Join(Split(ChampSage, "'"), "''") & "',InfosLibre=" & True & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                ElseIf IsDBNull(ChampSage) = False Then
                                    Insertion = "UPDATE TEMPLATE SET ChampSage='" & Join(Split(ChampSage, "'"), "''") & "',InfosLibre=" & True & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value.ToString & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                ElseIf IsDBNull(DataListeIntegrer.Rows(n).Cells("DefaultValue").Value) = False Then
                                    Insertion = "UPDATE TEMPLATE SET DefaultValue='" & Join(Split(ValeurDefault, "'"), "''") & "',InfosLibre=" & True & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value.ToString & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                Else
                                    Insertion = "UPDATE TEMPLATE SET DefaultValue='" & Join(Split(ValeurDefault, "'"), "''") & "',ChampSage='" & Join(Split(ChampSage, "'"), "''") & "',InfosLibre=" & True & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                End If
                            Else
                                ...
                                If IsDBNull(ValeurDefault) = False Or IsDBNull(ChampSage) = False Then
                                    Insertion = "UPDATE TEMPLATE SET DefaultValue='" & Join(Split(ValeurDefault, "'"), "''") & "',ChampSage='" & Join(Split(ChampSage, "'"), "''") & "',InfosLibre=" & False & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value.ToString & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                ElseIf IsDBNull(DataListeIntegrer.Rows(n).Cells("ChampSage").Value) = False Then
                                    Insertion = "UPDATE TEMPLATE SET ChampSage='" & Join(Split(ChampSage, "'"), "''") & "',InfosLibre=" & False & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value.ToString & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                ElseIf IsDBNull(DataListeIntegrer.Rows(n).Cells("DefaultValue").Value) = False Then
                                    Insertion = "UPDATE TEMPLATE SET DefaultValue='" & Join(Split(ValeurDefault, "'"), "''") & "',InfosLibre=" & False & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value.ToString & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                Else
                                    Insertion = "UPDATE TEMPLATE SET DefaultValue='" & Join(Split(ValeurDefault, "'"), "''") & "',ChampSage='" & Join(Split(ChampSage, "'"), "''") & "',InfosLibre=" & False & " where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value.ToString & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                End If
                            End If
                            ...
                            Insertion2 = "UPDATE TEMPLATE SET Societe='" & ComboSociete.Text & "' where  CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value.ToString & "'"
                            OleCommandEnreg = New OleDbCommand(Insertion2)
                            OleCommandEnreg.Connection = OleConnenection
                            OleCommandEnreg.ExecuteNonQuery()
                            Insert = True
                        End If
            ...
            If DataListeIntegrer.RowCount >= 0 Then
                ...
                If Cpter > 0 Then
                    If MessageBox.Show("Voulez-vous vraiment éffectuer cette Operation de Suppression ", "Information Suppresion", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
                        For n = 0 To DataListeIntegrer.RowCount - 1
                            If Trim(DataListeIntegrer.Rows(n).Cells("Suppression").Value) = "True" Then
                                Insertion = "DELETE FROM TEMPLATE  where Cols='" & DataListeIntegrer.Rows(n).Cells("Cols").Value & "' And CodeTbls ='" & DataListeIntegrer.Rows(n).Cells("CodeTbls").Value & "' AND Ligne=" & DataListeIntegrer.Rows(n).Cells("Ligne").Value.ToString & " And Entete=" & DataListeIntegrer.Rows(n).Cells("Entete").Value.ToString
                                OleCommandEnreg = New OleDbCommand(Insertion)
                                OleCommandEnreg.Connection = OleConnenection
                                OleCommandEnreg.ExecuteNonQuery()
                                Insert = True
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        End Try
    End Sub
    Private Sub AfficheSchemasConsoListe()
        Dim i As Integer
        ComboSociete.Items.Clear()
        For i = 0 To OledatableSchemaListe.Rows.Count - 1
            If OledatableSchema.Rows(0).Item("Societe") = OledatableSchemaListe.Rows(i).Item("Societe").ToString Then
                lblSociete.Text = OledatableSchema.Rows(0).Item("Societe")
            Else
                ComboSociete.Items.Add(OledatableSchemaListe.Rows(i).Item("Societe"))
            End If
        Next i
        'If ComboSociete.SelectedIndex <> 0 Then
        '    ComboSociete.SelectedIndex = 0
        'End If
    End Sub
    Public OleAdaptaterschemaListe As OleDbDataAdapter
    Public OleSchemaDatasetListe As DataSet
    Public OledatableSchemaListe As DataTable
    Private Sub BackgroundWorker4_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker4.DoWork
        Try
            OleAdaptaterschemaListe = Nothing
            OleSchemaDatasetListe = Nothing
            OledatableSchemaListe = Nothing
            OleAdaptaterschemaListe = New OleDbDataAdapter("select * from PARAMETRE WHERE nomtype='COMMERCIAL'", OleConnenectionArticle)
            OleSchemaDatasetListe = New DataSet
            OleAdaptaterschemaListe.Fill(OleSchemaDatasetListe)
            OledatableSchemaListe = OleSchemaDatasetListe.Tables(0)
        Catch ex As Exception
        End Try
    End Sub
